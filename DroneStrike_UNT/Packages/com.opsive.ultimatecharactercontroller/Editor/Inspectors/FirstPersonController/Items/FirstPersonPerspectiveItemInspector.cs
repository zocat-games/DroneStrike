    ...
    public class FirstPersonPerspectiveItemInspector : PerspectiveItemInspector
    {
        ...
        protected virtual void DrawMotionProperties()
        {
            if (Foldout("Position Spring")) {
                ...
                EditorGUILayout.PropertyField(PropertyFromName("m_BasePositionOffset"));
                if (Application.isPlaying && GUI.changed) {
                    (target as FirstPersonPerspectiveItem).BasePositionOffset = PropertyFromName("m_BasePositionOffset").vector3Value;
                }
