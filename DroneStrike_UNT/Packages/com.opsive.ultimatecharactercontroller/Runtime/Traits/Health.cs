...
namespace Opsive.UltimateCharacterController.Traits
{
    ...
    public class Health : StateBehavior, IDamageTarget
    {
        ...
        public DamagePopupMonitor DamagePopupMonitor
        {
            get { return m_DamagePopupMonitor; }
            set { m_DamagePopupMonitor = value; }
        }
        ...
        public float TimeInvincibleAfterSpawn
        {
            get { return m_TimeInvincibleAfterSpawn; }
            set { m_TimeInvincibleAfterSpawn = value; }
        }
        ...
        [Shared.Utility.NonSerialized] public Hitbox[] Hitboxes
        {
            get { return m_Hitboxes; }
            set { m_Hitboxes = value; }
        }

        public int MaxHitboxCollisionCount
        {
            get { return m_MaxHitboxCollisionCount; }
            set { m_MaxHitboxCollisionCount = value; }
        }

        public GameObject[] SpawnedObjectsOnDeath
        {
            get { return m_SpawnedObjectsOnDeath; }
            set { m_SpawnedObjectsOnDeath = value; }
        }

        public GameObject[] DestroyedObjectsOnDeath
        {
            get { return m_DestroyedObjectsOnDeath; }
            set { m_DestroyedObjectsOnDeath = value; }
        }

        public bool DeactivateOnDeath
        {
            get { return m_DeactivateOnDeath; }
            set { m_DeactivateOnDeath = value; }
        }

        public float DeactivateOnDeathDelay
        {
            get { return m_DeactivateOnDeathDelay; }
            set { m_DeactivateOnDeathDelay = value; }
        }

        public LayerMask DeathLayer
        {
            get { return m_DeathLayer; }
            set { m_DeathLayer = value; }
        }

        public AudioClipSet TakeDamageAudioClipSet
        {
            get { return m_TakeDamageAudioClipSet; }
            set { m_TakeDamageAudioClipSet = value; }
        }

        public AudioClipSet HealAudioClipSet
        {
            get { return m_HealAudioClipSet; }
            set { m_HealAudioClipSet = value; }
        }

        public AudioClipSet DeathAudioClipSet
        {
            get { return m_DeathAudioClipSet; }
            set { m_DeathAudioClipSet = value; }
        }

        public int DamagePopupManagerID
        {
            get { return m_DamagePopupManagerID; }
            set { m_DamagePopupManagerID = value; }
        }

        public UnityFloatVector3Vector3GameObjectEvent OnDamageEvent
        {
            get { return m_OnDamageEvent; }
            set { m_OnDamageEvent = value; }
        }

        public UnityFloatEvent OnHealEvent
        {
            get { return m_OnHealEvent; }
            set { m_OnHealEvent = value; }
        }

        public UnityVector3Vector3GameObjectEvent OnDeathEvent
        {
            get { return m_OnDeathEvent; }
            set { m_OnDeathEvent = value; }
        }
        ...
        {
            get { return (m_HealthAttribute != null ? m_HealthAttribute.Value : 0); }
            set
            {
                if (m_HealthAttribute != null)
                {
                    m_HealthAttribute.Value = value;
                }
            }
        }
        ...
        {
            get { return (m_ShieldAttribute != null ? m_ShieldAttribute.Value : 0); }
            set
            {
                if (m_ShieldAttribute != null)
                {
                    m_ShieldAttribute.Value = value;
                }
            }
        }
        ...
        public float Value
        {
            get { return HealthValue + ShieldValue; }
        }

        public Attribute HealthAttribute
        {
            get { return m_HealthAttribute; }
        }

        public Attribute ShieldAttribute
        {
            get { return m_ShieldAttribute; }
        }
