...
namespace Opsive.UltimateCharacterController.Traits
{
    ...
    public class Respawner : StateBehavior
    {
        ...
        public SpawnPositioningMode PositioningMode
        {
            get { return m_PositioningMode; }
            set { m_PositioningMode = value; }
        }
        ...
        {
            get { return m_MinRespawnTime; }
            set { m_MinRespawnTime = value; }
        }

        public float MaxRespawnTime
        {
            get { return m_MaxRespawnTime; }
            set { m_MaxRespawnTime = value; }
        }

        public bool ScheduleRespawnOnDeath
        {
            get { return m_ScheduleRespawnOnDeath; }
            set { m_ScheduleRespawnOnDeath = value; }
        }

        public bool ScheduleRespawnOnDisable
        {
            get { return m_ScheduleRespawnOnDisable; }
            set { m_ScheduleRespawnOnDisable = value; }
        }

        public AudioClipSet RespawnAudioClipSet
        {
            get { return m_RespawnAudioClipSet; }
            set { m_RespawnAudioClipSet = value; }
        }

        public UnityEvent OnRespawnEvent
        {
            get { return m_OnRespawnEvent; }
            set { m_OnRespawnEvent = value; }
        }
