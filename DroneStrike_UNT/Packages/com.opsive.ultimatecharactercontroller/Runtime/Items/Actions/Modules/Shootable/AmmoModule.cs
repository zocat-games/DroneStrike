...
namespace Opsive.UltimateCharacterController.Items.Actions.Modules.Shootable
{
    ...
    public class ItemAmmo : ShootableAmmoModule, IModuleGetItemIdentifiersToDrop, IModuleItemDefinitionConsumer
    {
        ...
        {
            base.UpdateRegisteredEventsInternal(register);
            Shared.Events.EventHandler.RegisterUnregisterEvent<IItemIdentifier, int, int>(register, Character, "OnInventoryAdjustItemIdentifierAmount", OnAdjustItemIdentifierAmount);
        }
