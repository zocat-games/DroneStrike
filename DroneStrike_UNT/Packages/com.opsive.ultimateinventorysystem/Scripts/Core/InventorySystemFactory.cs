...
namespace Opsive.UltimateInventorySystem.Core
{
    ...
    {
        public event Action<Item> OnItemCreation;
        ...
        {
            var newItem = Item.Create(itemDef, overrideAttributes);
            InvokeOnItemCreated(newItem);
            return newItem;
        }
        ...
        {
            var newItem = Item.Create(itemDef, id, overrideAttributes);
            InvokeOnItemCreated(newItem);
            return newItem;
        }
        ...
        {
            var newItem = Item.Create(item, overrideAttributes);
            InvokeOnItemCreated(newItem);
            return newItem;
        }
        ...
        {
            var newItem = Item.Create(item, id, overrideAttributes);
            InvokeOnItemCreated(newItem);
            return newItem;
        }
        ...
        /// <summary>
        /// Invoke an event that an item was created.
        /// </summary>
        /// <param name="item">The item that was created.</param>
        public virtual void InvokeOnItemCreated(Item item)
        {
            OnItemCreation?.Invoke(item);
        }
    }
}