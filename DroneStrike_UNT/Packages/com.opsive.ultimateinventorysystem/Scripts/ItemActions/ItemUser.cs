...
namespace Opsive.UltimateInventorySystem.ItemActions
{
    ...
    public class ItemUser : MonoBehaviour
    {
        ...
        [SerializeField] protected IPlayerInput m_InventoryInput;

        public virtual IPlayerInput InventoryInput
        {
            get
            {
                if (m_InventoryInput == null) {
                    m_InventoryInput = gameObject.GetCachedComponent<IPlayerInput>();
                }
        ...
        {
            if (m_InventoryInput == null) { m_InventoryInput = GetComponent<IPlayerInput>(); }
