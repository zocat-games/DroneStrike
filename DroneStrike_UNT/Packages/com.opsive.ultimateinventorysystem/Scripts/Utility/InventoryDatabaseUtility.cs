...
namespace Opsive.UltimateInventorySystem.Utility
{
    ...
    {
        public static InventorySystemDatabase s_MainEditorInventorySystemDatabase;
        ...
        public static bool TryGetMainInventorySystemDatabase(out  InventorySystemDatabase inventorySystemDatabase)
        {
            inventorySystemDatabase = null;
            
            if (Application.isPlaying == false || InventorySystemManager.IsNull) {
                
#if UNITY_2023_1_OR_NEWER
                inventorySystemDatabase = GameObject.FindFirstObjectByType<InventorySystemManager>()?.Database;
#else
                inventorySystemDatabase = GameObject.FindObjectOfType<InventorySystemManager>()?.Database;
#endif
            } else {
                inventorySystemDatabase = InventorySystemManager.Instance.Database;
            }
            ...
            if (inventorySystemDatabase == null) {
                if (Application.isPlaying) {
                    ...
                    inventorySystemDatabase = s_MainEditorInventorySystemDatabase;
                }
            }

            return inventorySystemDatabase;
        }
    }
}
