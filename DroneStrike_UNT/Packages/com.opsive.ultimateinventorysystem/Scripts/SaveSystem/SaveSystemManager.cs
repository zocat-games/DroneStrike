...
namespace Opsive.UltimateInventorySystem.SaveSystem
{
    ...
    public class SaveSystemManager : MonoBehaviour
    {
        ...
        protected virtual void SaveToDiskInternal(int saveIndex)
        {
            ...
            // Save MetaData.
            m_LoadedSaveData = new SaveDataInfo(m_LoadedSaveData, m_SaveMetaDataCreator.CreateMetaData(this, m_LoadedSaveData));
            m_LoadedSaveData = new SaveDataInfo(m_LoadedSaveData, saveIndex);
            
            var metaDataFile = File.Create(saveMetaDataFilePath);
            ...
            // Save SaveData.
            var dataFile = File.Create(saveFilePath);
        ...
        private void CreateDebugSaveDataFile(SaveDataInfo saveDataInfo)
        {
            ...
            using (FileStream fs = File.Create(dataFilePath)) {
                ...
                for (int i = 0; i < saveData.Count; i++) {
                    ...
                    var jsonSaverData = JsonUtility.ToJson(saveData.SerializedSaveData[i].DeserializeFields(MemberVisibility.All), true);
