...
namespace Opsive.UltimateInventorySystem.UI.Menus.Crafting
{
    ...
    public class RecipePanel : DisplayPanelBinding
    {
        ...
        [SerializeField] protected internal List<ItemViewWithDescription> m_IngredientItems;

        [Tooltip("The ingredient view parent.")]
        [SerializeField] protected internal RectTransform m_IngredientViewParent;
        [Tooltip("The ingredient description parent.")]
        [SerializeField] protected internal RectTransform m_IngredientDescriptionParent;
        ...
        protected virtual void InitializeDescriptions()
        {
        ...
        protected virtual void AssignInventoryToItemView(ItemView itemView)
        {
        ...
        public virtual void SetRecipe(CraftingRecipe recipe)
        {
            m_Recipe = recipe;
            Refresh();
        }
        ...
        /// </summary>
        protected virtual void DrawItemIngredients()
        {
            if (m_Recipe == null) {
        ...
        protected virtual void ClearItemIngredient(int i)
        {
        ...
        /// <param name="i">The index.</param>
        protected virtual void SetItemIngredient(ItemAmount itemAmount, int i)
        {
            if (m_IngredientItems[i].ItemView != null) {
        ...
        /// </summary>
        protected virtual void DrawCurrencyIngredients()
        {
