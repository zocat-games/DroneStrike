...
namespace Opsive.UltimateInventorySystem.UI.Grid
{
    ...
    public static class ItemShapeGridUtility
    {
        ...
        {
            return GetDestinationIndexInternal(dropHandler, true);
        }
        ...
        {
            return GetDestinationAnchorPosInternal(dropHandler, true);
        }
        ...
        /// <param name="dropHandler">The item view drop handler.</param>
        /// <returns>The index of the destination anchor.</returns>
        public static int GetDestinationIndex(ItemViewDropHandler dropHandler)
        {
            return GetDestinationIndexInternal(dropHandler, false);
        }
        ...
        /// <param name="dropHandler">The item view drop handler.</param>
        /// <returns>The position of the destination anchor.</returns>
        public static Vector2Int GetDestinationPos(ItemViewDropHandler dropHandler)
        {
            return GetDestinationAnchorPosInternal(dropHandler, false);
        }
        ...
        /// <param name="dropHandler">The item view drop handler.</param>
        /// <returns>The index of the destination anchor.</returns>
        private static int GetDestinationIndexInternal(ItemViewDropHandler dropHandler, bool withAnchor)
        {
            ...
            return destinationItemShapeGridData.TwoDTo1D(GetDestinationAnchorPosInternal(dropHandler, withAnchor));
        }
        ...
        /// <param name="dropHandler">The item view drop handler.</param>
        /// <returns>The position of the destination anchor.</returns>
        private static Vector2Int GetDestinationAnchorPosInternal(ItemViewDropHandler dropHandler, bool withAnchor)
        {
            if (!(dropHandler.DestinationContainer is ItemShapeGrid destinationItemShapeGrid)) {
            ...
            var pos =  new Vector2Int(
                sourceAnchorOffset.x + destinationPos.x,
                sourceAnchorOffset.y + destinationPos.y);

            if (withAnchor) {
                pos -= itemShape.Anchor;
            }
