...
namespace Opsive.UltimateInventorySystem.UI.Panels
{
    ...
    public class QuantityPickerPanel : DisplayPanel
    {
        ...
        /// </summary>
        public virtual void EnableQuantityButton()
        {
        ...
        /// </summary>
        public virtual void DisableQuantityButton()
        {
        ...
        /// </summary>
        protected virtual void QuantityPickerClicked()
        {
        ...
        public virtual async Task<int> WaitForQuantity()
        {
            await Task.Yield();
