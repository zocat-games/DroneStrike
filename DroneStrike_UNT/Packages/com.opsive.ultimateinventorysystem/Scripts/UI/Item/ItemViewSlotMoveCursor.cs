...
namespace Opsive.UltimateInventorySystem.UI.Item
{
    ...
    public class ItemViewSlotMoveCursor : ItemViewSlotsContainerBinding
    {
        ...
        [Tooltip("Event on start move.")]
        [SerializeField] protected UnityEvent m_OnMoveCanceled;
        [Tooltip("Draw the ItemViewSlotContainer on End")]
        [SerializeField] protected bool m_DrawOnMoveEnd = true;
        [Tooltip("Draw the ItemViewSlotContainer on Cancel")]
        [SerializeField] protected bool m_DrawOnMoveCancel = true;
        ...
        private void CancelMove()
        {
            ...
            m_OnMoveCanceled?.Invoke();
            if (m_DrawOnMoveCancel) {
