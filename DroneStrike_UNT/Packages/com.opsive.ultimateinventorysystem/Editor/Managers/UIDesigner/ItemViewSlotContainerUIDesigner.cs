...
namespace Opsive.UltimateInventorySystem.Editor.Managers.UIDesigner
{
    ...
    public class ItemActionsOptions : ItemViewSlotsContainerOption
    {
        ...
        protected NestedInspectedObjectField<CategoryItemActionSet, CategoryItemActionSetInspector>
            m_CategoryItemActionSet;
        protected NestedInspectedObjectField<ItemActionSet, ItemActionSetInspector>
        ...
        private void SetNestedObjectActionField()
        {
            if (m_ItemActionBinding is ItemViewSlotsContainerItemActionBinding itemActionsBinding) {
                ...
                m_CategoryItemActions = new NestedInspectedObjectField
                ...
                m_CategoryItemActionSet = new NestedInspectedObjectField
    ...
    public class ItemViewDrawerOptions : ItemViewSlotsContainerOption
    {
        ...
        protected NestedInspectedObjectField<CategoryItemViewSet, CategoryItemViewSetInspector> m_CategoryItemViewSetField;

        public ItemViewDrawerOptions(ItemViewSlotsContainerOptions itemViewContainerEditor) : base(itemViewContainerEditor)
        {
            m_CategoryItemViewSetField = new NestedInspectedObjectField<CategoryItemViewSet, CategoryItemViewSetInspector>(
    ...
    public class MovingItemsOptions : ItemViewSlotsContainerOption
    {
        ...
        public class CursorManagerOption : MovingItemsOption<ItemViewSlotCursorManager>
        {
            ...
            protected NestedInspectedObjectField<CategoryItemViewSet, CategoryItemViewSetInspector>
        ...
        public class DropHandlerOption : MovingItemsOption<ItemViewDropHandler>
        {
            ...
            protected NestedInspectedObjectField<ItemViewSlotDropActionSet, ItemViewSlotDropActionSetInspector>
            ...
            {
                m_ItemViewSlotDropActionSetField = new NestedInspectedObjectField<ItemViewSlotDropActionSet, ItemViewSlotDropActionSetInspector>(
