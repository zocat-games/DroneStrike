...
namespace Opsive.UltimateInventorySystem.Editor.Managers.UIDesigner
{
    ...
    public class UIDesignerSchemaSetupSubMenu : UIDesignerBoxBase
    {
        ...
        protected bool m_FailedToFindSchema = false;
        ...
        public UIDesignerSchemaSetupSubMenu()
        {
            ...
            if (defaultValue == null) {
                ...
                m_FailedToFindSchema = true;
                return;
            }

            m_FailedToFindSchema = false;
        ...
        public void Refresh()
        {
            ...
            if(m_FailedToFindSchema){ return; }
        ...
        void FetchSchemas()
        {
            var assetGUIDs = AssetDatabase.FindAssets("t:UIDesignerSchema", new[] { "Assets", "Packages" });
            m_Schemas.Clear();
