...
namespace Opsive.UltimateInventorySystem.Editor.Inspectors
{
    ...
    public class CategoryAttributeViewSetItemViewModuleInspector : InspectorBase
    {
        ...
        protected NestedInspectedObjectField<CategoryAttributeViewSet, CategoryAttributeViewSetInspector>
        ...
        {
            m_CategoryAttributeBoxSet = new NestedInspectedObjectField
