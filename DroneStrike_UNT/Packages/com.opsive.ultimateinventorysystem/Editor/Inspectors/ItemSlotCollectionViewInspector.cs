    ...
    public class ItemSlotCollectionViewInspector : DatabaseInspectorBase
    {
        ...
        protected override void InitializeInspector()
        {
            ...
            if (Application.isPlaying == false) {
                m_ItemSlotCollectionView.InitializeViewSlots(true);
            } else {
                m_ItemSlotCollectionView.InitializeViewSlots(false);
            }
        }
        ...
        protected override void ShowFooterElements(VisualElement container)
        {
            ...
            m_ItemSetSlotField.RegisterValueChangedCallback(evt =>
            {
                ...
                m_List = new List<ItemViewSlot>(m_ItemSlotCollectionView.ItemSlotItemViewSlots);
                OnValueChanged();
            });
            container.Add(m_ItemSetSlotField);
            
            m_ItemSlotCollectionView.ResizeItemViewSlotsToItemSlotsSetCount();
            if (m_ItemSlotCollectionView.ItemSlotItemViewSlots == null) {
                m_ItemSlotCollectionView.ItemSlotItemViewSlots = new ItemViewSlot[0];
            }
            m_List = new List<ItemViewSlot>(m_ItemSlotCollectionView.ItemSlotItemViewSlots);
        ...
        private void OnValueChanged()
        {
            ...
            m_ItemSlotCollectionView.ItemSlotItemViewSlots = m_List.ToArray();
