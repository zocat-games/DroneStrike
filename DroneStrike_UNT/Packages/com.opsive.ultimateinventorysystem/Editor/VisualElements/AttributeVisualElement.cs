    ...
    public class AttributeVisualElement : VisualElement
    {
        ...
        private void DrawValueAndInheritValue()
        {
            ...
            FieldInspectorView.AddField(
                ...
                "Value", string.Empty, LabelControl.WidthAdjustment.UnityDefault,
            ...
            FieldInspectorView.AddField(
                m_Attribute.GetAttachedObject(),
                m_Attribute, null, null,-1, attributeValueType,
                "Inherited Value", string.Empty, LabelControl.WidthAdjustment.UnityDefault,
        ...
        private void DrawOverrideValue()
        {
            ...
            FieldInspectorView.AddField(
                ...
                "Override Value", string.Empty, LabelControl.WidthAdjustment.UnityDefault,
